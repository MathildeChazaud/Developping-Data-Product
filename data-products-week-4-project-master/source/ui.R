...
shinyUI(
  ...
  navbarPage(
    ...
    tabPanel(
      ...
      h3("Author: Mathilde Chazaud - May, 2020"),
      ...
      p("Source code of this application is available at",
        a(href = "https://github.com/MathildeChazaud/Developping-Data-Product/edit/master/data-products-week-4-project-master",
          "https://github.com/MathildeChazaud/Developping-Data-Product/edit/master/data-products-week-4-project-master")
      )
